...
exports.getResetPassword = (req, res) => {
  const { token } = req.query;
  res.render('pages/reset_password', { token, message: null });
};
...
exports.resetPassword = async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            return res.render('pages/reset_password', { message: 'Invalid or expired token', token });
        }
        ...
        res.render('pages/reset_password', { message: 'Invalid or expired token', token });        
    }
}
